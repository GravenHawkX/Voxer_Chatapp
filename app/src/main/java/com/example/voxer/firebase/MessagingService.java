package com.example.voxer.firebase;
...
public class MessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(@NonNull RemoteMessage message) {
        ...
        //Here since phones now have permission heck for notifications this will only activate if we allow permissions.
        //Search up dependencies to get permission for notifs from user.
